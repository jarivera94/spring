...
@Service("estrategiaAsignados")
public class EstrategiaAvaluosAsignados extends EstrategiaAvaluo implements EstrategiaConsultaAvaluo {

    private static Logger log = LoggerFactory
            .getLogger(EstrategiaAvaluosAsignados.class);
    ...
    public long contarAvaluosPorFiltrosOrden(int primero,
        ...
        Predicate numeroDocumentoPerito = criteriaBuilder.equal(
                    perito.get(Usuario_.id).get("numeroDocumento"),
                    usuario.getNumeroDocumento());
        Predicate tipoDocumentoPerito = criteriaBuilder.equal(
                    perito.get(Usuario_.id)
    ...
    public List<AvaluoDTO> encontrarAvaluosPorFiltrosOrden(int primero,
        ...
        log.info("Query avaluos asignados: {}",
