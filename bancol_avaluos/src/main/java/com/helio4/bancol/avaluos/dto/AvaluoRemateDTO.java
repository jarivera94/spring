...
public class AvaluoRemateDTO extends AvaluoDTO implements Serializable, Cloneable {
	...
	public AvaluoRemateDTO() {
        super();
	}
	
    public AvaluoRemateDTO(Long id, boolean soloAvaluo, EntidadDTO entidad, String codigoExterno,
            TipoInmuebleDTO tipoDeInmueble, TipoAvaluoDTO tipoAvaluo,
            ObjetoAvaluoDTO objetoDelAvaluo, Integer motivo,
            Integer cambioGarantia, Long cambioGarantiaAvaluo,
            DivipolaDTO divipola, ListaSector sector,
            ...
            String numeroViaInforme,String adicionalDireccionInforme,String tipoCredito,
            String nombreSecuestre, String telefonoSecuestre, String celularSecuestre, String emailSecuestre, Long avaluoSisgenID) {
	...
	public AvaluoRemateDTO(AvaluoDTO avaluoDTO) {
	...
	public Object clone() throws CloneNotSupportedException {
		...
		AvaluoRemateDTO clone = new AvaluoRemateDTO(getId(), isSoloAvaluo(),
                ...
                getCambioGarantia(), getCambioGarantiaAvaluo(),
                (DivipolaDTO) getDivipola().clone(),
                getSector(), getConjunto(), getBarrio(), getTipoVia(),
                ...
                this.getPlacaInforme(), this.getNumeroViaInforme(), this.getAdicionalDireccionInforme(), this.getTipoCredito(),
                this.nombreSecuestre, telefonoSecuestre,  this.celularSecuestre, this.emailSecuestre, this.getAvaluoSisgenId()
				);
		return clone;
	}
