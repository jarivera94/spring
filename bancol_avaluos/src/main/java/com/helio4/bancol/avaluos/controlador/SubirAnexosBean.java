...
@Controller
@Scope("view")
@Qualifier("subirAnexosBean")
public class SubirAnexosBean implements Externalizable {

    private static Logger log = LoggerFactory.getLogger(SubirAnexosBean.class);
    ...
    @PostConstruct
    public void init() {
        IMAGES_PATH = parametrosController.obtenerValor("rutaAnexos");
        avaluo = listadoAvaluosBean.getAvaluo();
        fotografias = fotografiasController.buscarAnexosAvaluo(avaluo);
    ...
    private Panel crearPanelFotografia(int indice, FotografiaDTO fotografiaDTO) {
        ...
        MethodExpression methodExpression = expressionFactory
                .createMethodExpression(fc.getELContext(),
                        "#{subirAnexosBean.eliminarFotografia}", null,
    ...
    public String crearURLFotografia(Long id, String rutaAnterior) {
        return urlSeparator + "anexos" + urlSeparator
    ...
    public void subirFoto(FileUploadEvent event) {
        orden++;
        fotografiaDTO = fotografiasController.subirAnexo(event, IMAGES_PATH,
    ...
    public void actualizarDescripcion(AjaxBehaviorEvent event) {
        try {
            ...
            fotografiasController.actualizarAnexo(fotografia);
    ...
    public void eliminarFotografia(ActionEvent event) {
        ...
        try {
            ...
            fotografiasController.eliminarAnexo(fotoEliminada.getId());
    ...
    public void handleReorder(DashboardReorderEvent event) {
        ...
        try {
            ...
            fotografias = fotografiasController
                .moverAnexo(fotoMovida, posicionActual,
                    indiceNuevo, fotografias);
            log.info("anexos {}", fotografias);
        } catch (NumberFormatException e) {
